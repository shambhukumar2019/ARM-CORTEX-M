...
SRC ?= task1.c task2.c startup.S exception_handler.c main.c initializers.c
INC ?= stm32f407vg_disc1board


elf: 
	$(CC_PREFIX)-gcc -Wall -O0 -mcpu=$(CPU) -Tlinker.ld -Wl,-Map=main.map -I$(INC) -mthumb -g -nostartfiles $(SRC) -o $(TARGET).elf
